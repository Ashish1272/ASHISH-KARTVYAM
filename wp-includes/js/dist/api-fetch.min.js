...
this.wp = this.wp || {}, this.wp.apiFetch = function(e) {
    ...
    454: function(e, t, r) {
        ...
        var j = function(e) {
                ...
                return function(e, r) {
                    ...
                    if ("string" == typeof e.path) {
                        ...
                        if ("GET" === c && t[i]) {
                            var a = t[i];
                            return delete t[i], Promise.resolve(o ? a.body : new window.Response(JSON.stringify(a.body), {
                                status: 200,
                                statusText: "OK",
                                headers: a.headers
                            }))
                ...
                var e = Object(v.a)(h.a.mark((function e(t, r) {
                    ...
                    return h.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 19:
                                return u = e.sent, e.next = 22, m(u);
                            case 22:
                                s = e.sent, a = a.concat(s), i = x(u), e.next = 16;
                                break;
                            case 27:
        ...
        var J = function(e) {
            ...
            F = function(e) {
                var t = e.url,
                    ...
                    i = e.parse,
                    a = void 0 === i || i,
                    u = Object(o.a)(e, ["url", "path", "data", "parse"]),
                    s = e.body,
                    p = e.headers;
                return p = U(U({}, G), p), n && (s = JSON.stringify(n), p["Content-Type"] = "application/json"), window.fetch(t || r, U(U(U({}, H), u), {}, {
                    body: s,
                    headers: p
                })).then((function(e) {
        ...
        X.use = function(e) {
            ...
            F = e
        }, X.createNonceMiddleware = u, X.createPreloadingMiddleware = j, X.createRootURLMiddleware = b, X.fetchAllMiddleware = S, X.mediaUploadMiddleware = R;
        var q = t.default = X
    },
    47: function(e, t, r) {
        "use strict";
