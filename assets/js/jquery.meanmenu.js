! function(e) {
    ...
    e.fn.meanmenu = function(n) {
        var a = {
            ...
            meanMenuContainer: ".huruma-responsive-menu",
            meanMenuClose: "X",
        ...
        return this.each(function() {
            ...
            var w = "",
                ...
                A = !1,
                E = !1;
            "right" === s && (w = "right:" + m + ";left:auto;"), "left" === s && (w = "left:" + m + ";right:auto;"), x();
            var M = "",
                P = function() {
                    M.html(jQuery(M).is(".meanmenu-reveal.meanclose") ? r : u)
                },
                W = function() {
                ...
                S = function() {
                    ...
                    if (o >= t) {
                        ...
                        }), jQuery(e).before('<div class="mean-push" />'), jQuery(".mean-push").css("margin-top", c), jQuery(e).hide(), jQuery(".meanmenu-reveal").show(), jQuery(v).html(u), M = jQuery(v), jQuery(".mean-nav ul").hide(), h ? d ? (jQuery(".mean-nav ul ul").each(function() {
